...
$sql="insert into tblteacher(EmpID,FirstName,LastName,MobileNumber,Email,Gender,Dob,CourseID,Religion,Address,ProfilePic)values(:empid,:fname,:lname,:mobnum,:email,:gender,:dob,:cid,:religion,:address,:propic)";
